# **iOS Swift Advanced Course 2019**

Masters Academy «iOS Swift Advanced» course project for season 2019/2020
-----------------------------------------------------------------------
[![Join the chat at https://t.me/joinchat/E3gfskgpUc83uwbVgcSo9g](https://d22dkb9kbinceo.cloudfront.net/chat-DaW8.svg)](https://t.me/joinchat/E3gfskgpUc83uwbVgcSo9g)


# Terms and conditions
--------------------
 * Цей документ визначає та декларує чим є курси з iOS Swift Advanced які проводить Masters Academy в 2019-2020 рр.
 * Курси проводяться Masters Academy, на безоплатній добровільній основі.
 * Метою проведення курсів є допомога зацікавленим особам у вивченні mobile розробки та мови програмування Swift.
 ...
 * Доступ до курсів можуть отримати всі бажаючі, адекватні та розсудливі особи, із навичками програмування. Від студентів очікується мотивованість, готовність задавати питання та самостійно визначати яка саме допомога може бути надана викладачами.
...
# [Hometasks](https://github.com/MastersAcademy/ios-swift-advanced-2019/issues)
